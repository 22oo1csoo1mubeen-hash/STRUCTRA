...
@router.post(
    ...
    description=(
        ...
        "in the configured private Supabase Storage bucket without processing."
    ),
    responses={
        ...
        503: {"description": "Supabase Auth or Storage is unavailable."},
    },
)
async def upload_document(
    ...
    """Verify the user, validate the document, and store its original file."""
    if file is None:
        raise HTTPException(
